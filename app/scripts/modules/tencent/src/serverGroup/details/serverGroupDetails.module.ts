...
import { name as SECURITYGROUP_EDITSECURITYGROUPS_MODAL_CONTROLLER } from './securityGroup/editSecurityGroups.modal.controller';
...
module(SERVER_GROUP_DETAILS_MODULE, [
  ...
  SECURITYGROUP_EDITSECURITYGROUPS_MODAL_CONTROLLER,
