...
export const TENCENT_PIPELINE_STAGES_CLONESERVERGROUP_AWSCLONESERVERGROUPSTAGE =
  'spinnaker.tencent.pipeline.stage.cloneServerGroupStage';
export const name = TENCENT_PIPELINE_STAGES_CLONESERVERGROUP_AWSCLONESERVERGROUPSTAGE; // for backwards compatibility
angular
  .module(TENCENT_PIPELINE_STAGES_CLONESERVERGROUP_AWSCLONESERVERGROUPSTAGE, [])
  .config(function() {
