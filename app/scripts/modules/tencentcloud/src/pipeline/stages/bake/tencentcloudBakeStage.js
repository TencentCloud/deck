...
export const TENCENTCLOUD_PIPELINE_STAGES_BAKE = 'spinnaker.tencentcloud.pipeline.stage.bakeStage';
angular
  .module(TENCENTCLOUD_PIPELINE_STAGES_BAKE, [BAKEEXECUTIONDETAILS_CONTROLLER])
  .config(function() {
  ...
  .controller('tencentcloudBakeStageCtrl', [
    ...
    function($scope, $q, $uibModal) {
      ...
      function initialize() {
        $q.all({
          regions: BakeryReader.getRegions('tencentcloudcloud'),
